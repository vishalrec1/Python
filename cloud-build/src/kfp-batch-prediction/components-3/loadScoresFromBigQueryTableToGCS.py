...
@component(base_image=CUSTOM_SERVING_CONTAINER,
           ...
           # output_component_file='E:\\Python-code\\VertexAI-MLPipelines\\kfp-components-2\\yaml\\loadScoresFromBigQueryTableToGCS.yaml',
           output_component_file='/loadScoresFromBigQueryTableToGCS.yaml',
           packages_to_install=['google-cloud-aiplatform',
                                'google-cloud-bigquery', 'protobuf==3.20.3']
           )
